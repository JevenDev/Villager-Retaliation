...
Import follows the same strict folder rules as the game for known Villager Retaliation roots. Dialogue files stay dialogue, notification files stay notifications, and forced-dialogue files stay forced dialogue; quest and dialogue-tree JSON is recognized and preserved as pass-through content. Mixed old packs should be split into the documented folders before export.
