...
The builder writes dialogue options as `type: "dialogue_option"` with a separate `request`, and writes event chat through `output.mode: "chat"` on normal forced-dialogue triggers.
