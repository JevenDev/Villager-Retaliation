  ...
  els.panel.innerHTML = `
    <div class="builder-content">
      ...
      <div class="form-grid overview-grid">
        ...
        ${field({ id: "meta-packFormat", label: "Minecraft pack format", value: state.meta.packFormat, type: "number", help: `Default for ${version.label}: ${version.packFormat}.`, className: "span-5" })}
