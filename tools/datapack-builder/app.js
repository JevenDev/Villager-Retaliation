...
const FIELD_TOOLTIPS = {
  ...
  "meta-packVersion": "Targets a Villager Retaliation datapack format. Imported beta.11+ packs generated by this builder select this automatically; choose beta.12 for mood and social-attribute dialogue filters.",
...
const PACK_VERSION_SCHEMAS = {
  "1.0.0-beta.11": packVersionSchema({
    dialogueKeys: schemaKeysFromTooltips("dialogue")
      .filter((key) => !BETA_12_ONLY_DIALOGUE_KEYS.includes(key))
  }),
  "1.0.0-beta.12": packVersionSchema()
};
...
const PACK_MIGRATIONS = [
  {
    from: "1.0.0-beta.11",
    to: "1.0.0-beta.12",
    title: "Register beta.12 social attribute and mood dialogue fields",
    migrate(files, context) {
      context.report("info", "Dialogue fields", "No existing beta.11 fields are renamed or removed; beta.12 adds optional mood and social-attribute line filters.");
      return files;
    }
  }
];
...
function packVersionSchema({ dialogueKeys = schemaKeysFromTooltips("dialogue") } = {}) {
  return {
    collections: {
    ...
    <div class="builder-content">
      ...
      <div class="form-grid overview-grid">
        ...
        ${selectField({
          ...
          help: "Use beta.12 for mood and social-attribute dialogue filters. Imports generated by beta.11+ include this automatically.",
          className: "span-6",
          allowBlank: false
        })}
...
function addDialogueExample() {
  ...
  if (activeDialogueKind === "options") {
    ...
    state.dialogue.lines.push(cleanObject({
