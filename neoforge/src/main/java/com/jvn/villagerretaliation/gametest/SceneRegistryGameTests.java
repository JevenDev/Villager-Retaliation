...
public final class SceneRegistryGameTests {
    ...
    public static void eliteEncounterMembersApplySafeAttributesAfterVanillaInitialization(GameTestHelper helper) {
        ...
        EncounterTemplate eliteOnly = EncounterResources.parse(
                ...
                JsonParser.parseString("""
                        ...
                        """).getAsJsonObject(),
                eliteErrors);
        helper.assertTrue(eliteOnly != null && eliteErrors.isEmpty(), "elite-only fixture should parse: " + eliteErrors);
        helper.assertValueEqual(EncounterService.completionGutsReward(eliteOnly), 3, "elite encounter guts reward");
        helper.assertValueEqual(EncounterService.completionGutsReward(template), 5, "boss encounter guts reward");
        ...
        Villager veteran = (Villager) helper.getLevel().getEntity(
                encounter.allies().get("veteran").entityId());
