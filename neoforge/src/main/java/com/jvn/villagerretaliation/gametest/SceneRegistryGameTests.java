...
public final class SceneRegistryGameTests {
    ...
    public static void movementWaitsForChunkThenReconcilesArrivalAndTimeout(GameTestHelper helper) {
        ...
        helper.getLevel().getChunk(target.getX()>>4,target.getZ()>>4);villager.teleportTo(target.getX()+.5,target.getY(),target.getZ()+.5);SceneInstance loaded=SceneInstance.load(instance.save());
