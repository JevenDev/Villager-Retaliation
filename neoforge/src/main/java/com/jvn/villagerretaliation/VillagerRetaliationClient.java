...
public final class VillagerRetaliationClient {
    public VillagerRetaliationClient(IEventBus modEventBus, ModContainer modContainer) {
        ...
        NeoForge.EVENT_BUS.addListener(com.jvn.villagerretaliation.client.party.PartyInventoryOverlay::onScreenRender);
        NeoForge.EVENT_BUS.addListener(com.jvn.villagerretaliation.client.party.PartyInventoryOverlay::onMousePressed);
        NeoForge.EVENT_BUS.addListener(com.jvn.villagerretaliation.client.party.PartyInventoryOverlay::onMouseReleased);
