...
public final class VillagerRetaliationConfigModel {
    ...
    public static final class Balance {
        ...
        public int hiredWorkDecisionBudget = 8;

        @RangeConstraint(min = 0, max = 600)
        public int hiredWorkNoticeCooldownSeconds = 600;
    ...
    public static final class DebugOverlay {
        ...
        public boolean showQuestJournalTags = false;
    ...
    public static final class Quest {
        public boolean showQuestIndicators = true;
