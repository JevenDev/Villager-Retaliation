...
const catalog = [
  ...
  ["Commands.md", "Getting Started", "terminal", "Complete player and operator command syntax for parties, duels, diagnostics, quests, scenes, villagers, villages, and debug tools."],
  ["Dialogue.md", "Dialogue", "message-square-text", "Talk options, rich text variants, durable usage rules, metadata tags, tuning, and conversation text."],
  ...
  ["Quests.md", "Quests & Scenes", "scroll-text", "Quest module v2 providers, rotating pools, active caps, payload-aware triggers, objectives, branches, rewards, and diagnostics."],
...
const related = {
  ...
  "commands": ["pack-development", "quests", "quest-scenes", "tracked-villages"],
...
const output = `// Generated by wiki/dev/build-data.mjs. Do not edit directly.\nwindow.VR_DEVELOPER_WIKI_DATA = ${JSON.stringify(data, null, 2)};\n`;
