// Generated by wiki/dev/build-data.mjs. Do not edit directly.
window.VR_DEVELOPER_WIKI_DATA = {
  ...
  "pages": [
    ...
    },
    {
      ...
      "text": "First Quest Guide This guide walks through the smallest complete quest that feels playable in game. For new packs, start with one owner bundle. The inline JSON in this guide is browser builder input; beta.13 export replaces player facing strings with localized references and writes exhaustive English beside quest.json. What You Are Making This example adds a farmer quest named Bread Delivery. The player can: 1. Talk to a farmer and accept the quest. 2. Gather 16 bread. 3. Track the objective in the quest HUD and journal. 4. Return to the same quest giver and turn it in. Builder Input And Exported Files Create: What this file does: Section Meaning schema Selects quest module v2 id The stable quest id used by dialogue, commands, saves, and overrides metadata Title, description, questline, and tags provider Which villagers can offer the quest availability Repeat, cooldown, abandonment, and locking behavior entry stage The first stage stages[].objectives What the player must do stages[].dialogue Offer, reminder, and turn in Talk menu scenes stages[].scenes Action scenes reached from response buttons rewards What the player receives on turn in ui Tracker text, icon, and optional title/outline colors Validation And Diagnostics The repository validator accepts a quest file directly: Runtime diagnostics are available through: The debug inspector reports saved state, availability, active conditions, issuer data, objective counters, cooldowns, current stage, and branch locks. Common Mistakes Symptom Likely cause Quest never appears in Talk menu Missing schema, wrong path, bad provider filters, or availability gates fail Quest starts but cannot be turned in Objective is not complete, turn in scene is missing, or turn in action is unavailable Any villager offers the quest provider.filters.professions is missing or too broad Quest appears for the wrong story branch Missing metadata.parent, availability.conditions, or branch lock rules Tracker text is vague Add ui.tracker text or objective tracker.text Player cannot find the quest giver Keep locked to villager: true for personal favors. Use cross villager compatible: true only when another villager should continue the same quest Advanced item objective highlights the wrong stack Ensure the active objective and synchronized tracker were refreshed after the datapack reload; highlights now use components, enchantments, durability, and custom data requirements When To Add More Files The exported owner bundle always includes quest.json and exhaustive locales/en us.json. Add locales/ .json when you have translated messages; it may be partial and falls back per key to effective English. Add a private persistent scene, encounter, or wrapped reward only when the quest behavior needs one: Keep offer, reminder, turn in, response, and branch structure in quest.json. Put reusable companion definitions or absolute shared messages under quests/ shared/ instead of referencing another quest's private files. Forced dialogue is a separate global system for event driven interruptions, warnings, or confrontations outside the Talk menu. A quest may call a stable forced dialogue ID, but that definition is not part of the owner bundle and cannot replace structural quest dialogue. Legacy Layout Note Beta.13 diagnoses loose v1 and v2 quest files and old companion roots as unsupported; it does not load them. Convert them offline to an owner bundle before changing the pack target. Next Steps Quests Quests.md covers stages, transitions, branches, targets, bundle companions, forced dialogue actions, and diagnostics. Dialogue Trees Dialogue Trees.md covers standalone branching conversations and the quest ownership boundary. Dialogue And Quests Dialogue And Quests.md covers bundle transactions, structural dialogue, and locale ownership. Localization Localization.md covers locale catalogs and message key resolution.",
      "headings": [
        {
          "level": 2,
        ...
        {
          "level": 2,
          "title": "Builder Input And Exported Files"
        },
        {
          "level": 2,
    ...
    },
    {
      ...
      "text": "Example Packs These folders are working test packs, not just JSON fragments. Copy the smallest example that covers your system, change its namespace and IDs, then run /reload. Sell Prices example packs/sell prices example/ keeps a legacy beta.13 price beside explicit rates, tag pricing, discrete prices, component matching, durability, a built in override, and a disabled definition. Its README calls out the fictitious mod and tag IDs used for illustration. Custom Duel Kits example packs/custom duel kits/ adds an enchanted duel examples:champion kit with temporary equipment for the player and villager. See Duel Kits Duel Kits.md for every field. Skill Trades And Special Orders example packs/skill trades special orders/ adds profession specialty and farming order pools that demonstrate skill gates, reputation, trade level ranges, persistent trade stock, and targetable Special Orders. See Skill Trades Skill Trades.md for the schema and refresh behavior. Persistent Cinematic Gate Ambush example packs/cinematic gate ambush/ is the complete beta.13 scene orchestration example: two named villagers, player/party ownership, a recorded choice branch, movement, dialogue, a persisted wait, controlled encounter scaling and cleanup, quest completion/failure, and provider unload recovery. Repeatable scene run identity example packs/repeatable scene run id/ is a deliberately small repeatable quest. It launches the same scene operation twice in one run (one instance), then demonstrates that a later legitimate run and an unrelated player's run receive different QUEST INSTANCE owners. The repo already includes a full starter datapack you can copy from: This is the best source of the current folderized dialogue format introduced in beta.12. Its quest is a beta.13 owner bundle, and the scene examples above cover the persistent quest runtime surface. What Is In The Template Area Example path Dialogue option example packs/dialogue folder template/data/example template/dialogue/en us/example template/options/00 greeting.json Dialogue line example packs/dialogue folder template/data/example template/dialogue/en us/example template/lines/00 greeting.json Keyed message example packs/dialogue folder template/data/example template/dialogue/en us/example template/messages/00 example.json Forced dialogue example packs/dialogue folder template/data/example template/forced dialogue/example template/00 container theft.json Notification example packs/dialogue folder template/data/villagerretaliation/notifications/en us/example template/00 ambient.json Gifts example packs/dialogue folder template/data/villagerretaliation/gifts/example template/00 gifts.json Pacification example packs/dialogue folder template/data/villagerretaliation/pacification/example template/00 payments.json Profession loot example packs/dialogue folder template/data/villagerretaliation/profession loot/example template/00 loot.json Villager names example packs/dialogue folder template/data/villagerretaliation/villager names/example template names.json Smallest Copyable Pack If you want the lightest possible starting point, copy only: Example option: Example line: When To Copy The Full Template Copy the whole dialogue folder template when you want: one file per dialogue request a translator friendly folder layout current examples for conditions, filters, message keys, and a beta.13 quest bundle a reference pack that covers almost every authoring surface Minimal pack.mcmeta Add your own villagerretaliation.pack version marker only if your workflow already expects it. The builder will add it automatically on export for supported versions.",
      "headings": [
        {
          "level": 2,
          "title": "Sell Prices"
    ...
    },
    {
      "slug": "commands",
      "file": "Commands.md",
      "source": "wiki/dev/content/Commands.md",
      "sourceKind": "wiki",
      "group": "Getting Started",
      "icon": "terminal",
      "title": "Commands",
      "description": "Complete player and operator command syntax for parties, duels, diagnostics, quests, scenes, villagers, villages, and debug tools.",
      ...
      "text": "Commands All Villager Retaliation commands use the /vr root. Run /vr, /vr party, /vr duel, /vr admin, or /vr admin debug in game for a short localized summary, and use Tab completion for IDs, selectors, enum values, players, and other suggested arguments. Notation on this page: is required. [value] is optional. Entity arguments accept normal Minecraft selectors where the command permits them. /vr admin requires permission level 2. Player commands do not require operator permission, but they must be run by a player where the action needs one. Command names are case sensitive. In particular, keep camel case literals such as forceStart, whyAvailable, inspectHere, and cleanupEncounter exactly as shown. Player Commands Parties Command Purpose /vr party create Create a player party. /vr party invite Invite an online player. /vr party accept [player] Accept the latest invitation, or the invitation from the named player. /vr party decline [player] Decline the latest invitation, or the invitation from the named player. /vr party leave Leave the current party. /vr party kick Remove a party member; leader permission is checked by the party service. /vr party promote Transfer party leadership to a member. /vr party disband Disband the party. /vr party alliance request Request an alliance with the named player's party. /vr party alliance accept Accept that party's alliance request. /vr party alliance cancel Cancel the outgoing request to that party. /vr party alliance end End the alliance with that party. Player Duels Command Purpose /vr duel challenge [kit] [wager] Challenge a player. Omitted kit defaults to bring your own and omitted wager defaults to 0. Kit IDs are suggested; wagers must be non negative. /vr duel accept [player] Accept the latest challenge, or the challenge from an online player. /vr duel decline [player] Decline the latest challenge, or the challenge from an online player. Operator Commands Villager Profiles, Skills, And Social State Command Purpose /vr admin villager profile get Show the villager's social profile. /vr admin villager profile set Set a suggested Social Attribute to its bounded value. /vr admin villager profile reroll Reroll the profile. /vr admin villager profile export Export profile data for debugging. /vr admin villager skill get [skill] Show every skill, or one suggested skill. /vr admin villager skill set Set a skill to its bounded value. /vr admin villager skill reroll Reroll skills. /vr admin villager gender set Set a suggested stored gender value. /vr admin villager reputation set Set the named player's reputation on one or more target entities. /vr admin villager relationship set Set a suggested relationship stage between two entities. The argument supports a UUID, a normal entity selector, or an exact custom/preset name. A plain name must resolve to exactly one loaded villager. Villager Allegiance Command Purpose /vr admin villager allegiance inspect Show saved allegiance and assignment history. /vr admin villager allegiance explain Explain the assignment rule and current state. /vr admin villager allegiance assign Assign a village identity directly. /vr admin villager allegiance unknown Mark allegiance unresolved so normal resolution can retry. /vr admin villager allegiance unaffiliated Mark the entity as a Wanderer/unaffiliated. /vr admin villager allegiance merge Merge allegiance identities. /vr admin villager allegiance undoMerge Undo the latest eligible merge for the source identity. /vr admin villager allegiance fork Fork an entity into a new allegiance identity. /vr admin villager allegiance repair Retry migration or repair a stuck assignment. /vr admin villager allegiance statistics Show assignment statistics. /vr admin villager allegiance resetAbuse Reset saved abuse state for that player and entity. Tracked Villages Command Purpose /vr admin village inspectHere Inspect the tracked village at the operator's position. /vr admin village renameHere Rename the local tracked village; the rest of the line is used as the name. /vr admin village list List tracked villages. /vr admin village registry inspect [limit] Inspect up to 10 registry entries by default, or 1 50 when supplied. /vr admin village registry pruneOlderThan Prune eligible registry data older than the non negative tick age. /vr admin village registry suggestMerges [radius] [limit] Suggest registry key merges using bounded radius and 1 50 result limits. /vr admin village registry merge Merge two suggested registry keys. Quote keys when needed. Datapack And Dialogue Diagnostics Command Purpose /vr admin datapack diagnostics Show current datapack diagnostics. /vr admin datapack diagnostics severity Filter by suggested diagnostic severity. /vr admin datapack diagnostics severity resource Filter by severity and resource string. /vr admin datapack diagnostics resource Filter by resource string. /vr admin dialogue explain [option] Explain dialogue candidate matching for a suggested request and optional option ID. Quests Command Purpose /vr admin quest providers [radius] List matching loaded providers in the default or supplied bounded radius. /vr admin quest start Start a suggested quest when ordinary start rules pass. /vr admin quest forceStart Force the debug start path while retaining structural/provider validation. /vr admin quest remove Remove the player's quest state. /vr admin quest inspect Inspect saved state, provider binding, stages, objectives, facts, and deferred work. /vr admin quest rebind Rebind an eligible missing provider after filter validation. /vr admin quest whyAvailable Explain why a provider can or cannot offer the quest. /vr admin quest whyHidden [provider] Explain why the quest is hidden, optionally against a specific provider. /vr admin quest objectives Show objective state. /vr admin quest setStage Move debug state to the named stable stage. /vr admin quest fireTrigger Fire a suggested registered quest event for testing. /vr admin quest actions dryRun Evaluate a trigger's actions without committing them. /vr admin quest facts Show facts for the supplied scope key; the rest of the line is accepted. Quest trace commands are: show defaults to the trace buffer capacity and accepts a bounded positive limit. capture records the selected quest/provider evaluation. Persistent Scenes And Encounters Command Purpose /vr admin scene list List persistent scene runs. /vr admin scene inspect Show the scene's current saved state. /vr admin scene trace Show detailed trace lines. /vr admin scene retry Retry a blocked or failed operation when the runtime permits it. /vr admin scene cancel Cancel the scene. /vr admin scene resume Resume an eligible paused or blocked scene. /vr admin scene rebind Rebind an actor alias to one entity. /vr admin scene cleanupEncounter Run encounter cleanup by durable encounter ID. Scene and encounter IDs shown by these commands are runtime IDs, not necessarily datapack template resource IDs. Debug And Test Tools These commands mutate test state or can create many entities. Use them in disposable worlds or backups. Command Purpose /vr admin debug duel [kit] [wager] Start a villager duel test. Kits include byo, bring your own, bare handed, melee, ranged, and armored; wager is non negative. /vr admin debug hired previews [radius] Toggle hired work debug previews with an optional bounded radius. /vr admin debug hired stressGrid [count] Spawn the default role count stress grid or a bounded count. /vr admin debug hired inspect Inspect hired work runtime state. /vr admin debug raid win Force the active debug Player Raid to its win path. /vr admin debug raid lose Force its loss path. /vr admin debug builder materials Place material chests for a suggested registered builder structure. /vr admin debug transferVillagerOwnership Transfer supported villager ownership/controller state to exactly one player profile. Troubleshooting If a command is missing, confirm the server and client use the same mod version and use /vr rather than an older root. If /vr admin is hidden or rejected, grant permission level 2 or run it from the server console where the command does not require a player position. If a named villager is ambiguous, use a UUID or a narrow selector such as @e[type=minecraft:villager,sort=nearest,limit=1]. Use /vr admin datapack diagnostics after /reload, then the feature specific explain, whyAvailable, whyHidden, inspect, or trace command. Mutating quest and scene commands are debugging and repair tools. Back up saves before changing live quest stages, bindings, facts, ownership, or village identities.",
      "headings": [
        {
          "level": 2,
        ...
        {
          "level": 3,
          "title": "Villager Profiles, Skills, And Social State"
        },
        {
          "level": 3,
          "title": "Villager Allegiance"
        },
        {
          "level": 3,
        ...
        {
          "level": 3,
          "title": "Datapack And Dialogue Diagnostics"
        },
        {
          "level": 3,
          "title": "Quests"
        ...
        {
          "level": 3,
          "title": "Persistent Scenes And Encounters"
        },
        {
          "level": 3,
          "title": "Debug And Test Tools"
        },
        {
          "level": 2,
    ...
    },
    {
      ...
      "text": "Dialogue Trees Dialogue trees define standalone Talk menu conversations with several authored responses. They remain a global dialogue system, but they are not companions for beta.13 quest bundles. Quest offer, reminder, turn in, response, and branch structure always stays in the owning bundle's quest.json. A dialogue tree may inspect quest state like any other global conversation, but it cannot own or override a quest's structural dialogue. Paths Do not place beta.13 quest owned trees under a quests/ convention or reference them with external scene. Those old patterns are diagnosed as unsupported quest layout. Minimal Standalone Tree What Goes Where Part Purpose entries Talk menu buttons that open the tree nodes Villager lines, player responses, and actions responses Buttons shown inside the standalone scene actions State changes such as giving XP, writing facts, or triggering another global system Trees, entries, nodes, and responses accept the shared conditions array. They may query a quest by stable ID without becoming part of that quest's owner transaction: Node lines and response text accept the rich variant objects documented in Dialogue Dialogue.md rich text variants. Ordered variants retain priority, chance, weight, conditions, usage policy, and authored order. Replacing Or Removing Trees At the top of a dialogue tree file: puts the standalone dialogue tree loader in replacement mode. VR skips built in tree resources, then loads add on tree files normally. In non default locales, replacement mode also clears inherited fallback trees before applying that locale's add on trees. removes one global tree by stable ID. If id is omitted, the legacy loader infers it from the file path; new content should declare the ID explicitly. Quest Boundary Do not use external scenes, external, external scene, or external entry in a beta.13 quest. Keep structural dialogue in quest.json, localized wording in the bundle's locales/ .json, and persistent runtime scenes in the bundle's scenes/ .json. Forced dialogue is another separate global system for locked event driven interruptions. Referencing a stable forced dialogue ID from a quest action is legal, but it does not move quest dialogue ownership out of the bundle. Use dialogue trees for standalone lore, services, or global conversations that need several responses. Use Quests Quests.md for quest state and structural quest dialogue, and normal Dialogue Dialogue.md when one option and one reply are enough.",
      "headings": [
        {
          "level": 2,
          "title": "Paths"
        ...
        {
          "level": 2,
          "title": "Replacing Or Removing Trees"
        },
        {
          "level": 2,
          "title": "Quest Boundary"
        }
      ],
      "related": [
        "dialogue-and-quests",
    ...
    },
    {
      ...
      "headings": [
        ...
        {
          "level": 2,
          "title": "Provider Protection And Hiring Policy"
        },
        {
          "level": 2,
        ...
        {
          "level": 2,
          "title": "Unsupported Legacy Layout"
        },
        {
          "level": 2,
    ...
    },
    {
      ...
      "text": "Dialogue And Quests Beta.13 quest content is owned by a bundle. Structural offer, reminder, turn in, response, and branch dialogue stays in quest.json; player facing wording lives in the bundle locale catalog. Bundle Layout A bundle directory defines ownership only. Every quest, scene, encounter, reward, and pool still declares an explicit stable ID. The quest namespace must match data/ , metadata.questline must match , and the one segment quest ID path must match . The quest structure, private companions, bundled rewards, and effective English form one owner bundle transaction. An invalid higher layer is rejected as a unit and the lower valid layer remains active. Each optional non English locale overlay is validated independently. Structural Dialogue Keep dialogue shape and ordering in quest.json. Use localized references for every schema designated player facing field: title expands relative to the required immutable localization prefix. Existing absolute message IDs remain supported. A new third party prefix must begin with its namespace and be globally unique. There is no public quest dialogues root and no external, external scene, external entry, or external scenes escape hatch. Long structural branches still belong in quest.json; moving source files must not change persistent IDs or generated localization keys. Locale Ownership The introducing layer supplies exhaustive English for its bundle owned references: Other locales may be partial. Resolution falls back per message ID to effective en us at the existing per player boundary, so two players can see the same catalog snapshot in different locales. Rich variants preserve authored ordering, formatting, placeholders, weights, and conditions. Each expanded message ID has one canonical owner bundle or shared. A higher datapack may override the same owner, but duplicate ownership inside one pack or moving ownership between bundles is an error. Put reusable absolute messages in shared; keep private wording with its quest. Scene, Encounter, And Reward Companions Persistent runtime scenes, encounters, and bundled reward tables may live in their owning quest directory. Reference them by their explicit stable IDs. Private companions cannot be referenced by another quest; reusable definitions belong under shared. These companions are not extracted structural dialogue trees. A scene companion models persistent runtime steps and actors, while quest.json continues to own Talk menu dialogue and branches. Forced Dialogue Forced dialogue is a separate global event system, not a quest bundle companion. A quest action may reference a stable forced dialogue ID when an event driven interruption needs live player and provider context: The global forced dialogue definition keeps its own stable ID. It does not participate in the bundle transaction and must not be used to replace offer, reminder, turn in, or response structure. Legacy Layout Beta.13 diagnoses loose v1 or v2 quest JSON, quest messages, quest scenes, quest encounters, quest pools, old quest reward roots, and quest owned dialogue trees as unsupported. The runtime never silently falls back to them. Convert legacy content offline or import it into the browser builder, then export a bundle containing pack.mcmeta and data/.",
      "headings": [
        {
          "level": 2,
          "title": "Bundle Layout"
        ...
        {
          "level": 2,
          "title": "Structural Dialogue"
        },
        {
          "level": 2,
          "title": "Locale Ownership"
        },
        {
          "level": 2,
          "title": "Scene, Encounter, And Reward Companions"
        },
        {
          "level": 2,
          "title": "Forced Dialogue"
    ...
    },
    {
      ...
      "headings": [
        ...
        {
          "level": 3,
          "title": "Localized encounter presentation"
        },
        {
          "level": 3,
  ...
  "examples": [
    ...
    },
    {
      ...
      "section": "Builder Input And Exported Files",
      "level": "Starter",
      "language": "json",
      "code": "{\n  \"schema\": \"villagerretaliation:quest/v2\",\n  \"id\": \"my_pack:bread_delivery\",\n  \"metadata\": {\n    \"title\": \"Bread Delivery\",\n    \"description\": \"Bring 16 bread to the village stores.\",\n    \"questline\": \"village_supply\",\n    \"tags\": [\"group.village_supply\"]\n  },\n  \"provider\": {\n    \"type\": \"villagerretaliation:villager\",\n    \"filters\": {\n      \"professions\": [\"minecraft:farmer\"],\n      \"min_villager_level\": \"novice\"\n    }\n  },\n  \"availability\": {\n    \"repeatable\": true,\n    \"completion_cooldown_days\": 1,\n    \"locked_to_villager\": true,\n    \"cross_villager_compatible\": false,\n    \"abandonment\": \"allow_repickup\",\n    \"consume_on_completion\": true\n  },\n  \"entry_stage\": \"gather\",\n  \"stages\": [\n    {\n      \"id\": \"gather\",\n      \"objectives\": [\n        {\n          \"id\": \"bring_bread\",\n          \"type\": \"item_check\",\n          \"item\": \"minecraft:bread\",\n          \"count\": 16,\n          \"tracker\": {\n            \"text\": \"Bring 16 bread back to the quest giver.\",\n            \"complete_text\": \"The bread is packed and ready.\",\n            \"show_progress\": true,\n            \"progress\": 0.75\n          }\n        }\n      ],\n      \"dialogue\": {\n        \"offer\": {\n          \"label\": \"Bread Delivery\",\n          \"request\": \"question\",\n          \"order\": -20,\n          \"show_for_babies\": false,\n          \"lines\": [\n            \"The bins are low. Sixteen bread would quiet a lot of worried stomachs.\"\n          ],\n          \"responses\": [\n            {\n              \"id\": \"accept\",\n              \"label\": \"I can help stock the larder.\",\n              \"scene\": \"start_quest\"\n            },\n            {\n              \"id\": \"decline\",\n              \"label\": \"Another time.\",\n              \"scene\": \"decline\"\n            }\n          ]\n        },\n        \"reminder\": {\n          \"label\": \"About Bread Delivery\",\n          \"request\": \"question\",\n          \"order\": -20,\n          \"show_for_babies\": false,\n          \"lines\": [\n            \"Bread Delivery is still open. The tracker has the count.\"\n          ],\n          \"responses\": [\n            {\n              \"id\": \"leave\",\n              \"label\": \"I'll keep looking.\",\n              \"scene\": \"end\"\n            }\n          ]\n        },\n        \"turn_in\": {\n          \"label\": \"About Bread Delivery\",\n          \"request\": \"question\",\n          \"order\": -20,\n          \"show_for_babies\": false,\n          \"lines\": [\n            \"If that pack smells like fresh bread, you may have saved me an argument.\"\n          ],\n          \"responses\": [\n            {\n              \"id\": \"complete\",\n              \"label\": \"Show what I brought.\",\n              \"scene\": \"complete_quest\"\n            },\n            {\n              \"id\": \"leave\",\n              \"label\": \"Not yet.\",\n              \"scene\": \"end\"\n            }\n          ]\n        }\n      },\n      \"scenes\": [\n        {\n          \"id\": \"start_quest\",\n          \"actions\": [\n            {\n              \"type\": \"quest\",\n              \"action\": \"start\",\n              \"lines\": {\n                \"started\": [\n                  \"Good. Bring the bread back when the count is ready.\"\n                ],\n                \"unavailable\": [\n                  \"The larder is not asking you for bread right now.\"\n                ]\n              }\n            }\n          ]\n        },\n        {\n          \"id\": \"complete_quest\",\n          \"actions\": [\n            {\n              \"type\": \"quest\",\n              \"action\": \"turn_in\",\n              \"lines\": {\n                \"completed\": [\n                  \"Good. A full shelf makes brave talk sound less hollow.\"\n                ],\n                \"missing_objectives\": [\n                  \"Bread Delivery is still short. The tracker has the exact count.\"\n                ],\n                \"unavailable\": [\n                  \"This bread delivery is not ready to close yet.\"\n                ]\n              }\n            }\n          ]\n        },\n        {\n          \"id\": \"decline\",\n          \"text\": \"Then I will keep counting crumbs and pretending it is planning.\"\n        },\n        {\n          \"id\": \"end\",\n          \"text\": \"Keep the bread close until you are ready.\"\n        }\n      ]\n    }\n  ],\n  \"rewards\": {\n    \"experience\": 60,\n    \"reputation\": 5,\n    \"gossip_reputation\": 2\n  },\n  \"ui\": {\n    \"tracker_text\": \"Bring 16 bread.\",\n    \"icon\": \"minecraft:bread\",\n    \"color\": \"#DCEBA6\"\n  }\n}"
    },
    ...
    },
    {
      ...
      "section": "Minimal Standalone Tree",
      "level": "Starter",
      "language": "json",
      "code": "{\n  \"id\": \"my_pack:village_history\",\n  \"display\": {\n    \"title\": \"Village History\",\n    \"description\": \"A short lore conversation.\"\n  },\n  \"entries\": [\n    {\n      \"id\": \"history\",\n      \"label\": \"Ask About The Village\",\n      \"request\": \"story\",\n      \"start\": \"history\"\n    }\n  ],\n  \"nodes\": {\n    \"history\": {\n      \"lines\": [\n        \"This place was smaller once. Safer too, depending on who you ask.\"\n      ],\n      \"responses\": [\n        {\n          \"id\": \"road\",\n          \"label\": \"What about the old road?\",\n          \"next\": \"road\"\n        },\n        {\n          \"id\": \"leave\",\n          \"label\": \"Thanks.\",\n          \"end\": true\n        }\n      ]\n    },\n    \"road\": {\n      \"lines\": [\"The old road remembers more travelers than we do.\"],\n      \"end\": true\n    }\n  }\n}"
    },
    ...
    },
    {
      ...
      "page": "dialogue-trees",
      "pageTitle": "Dialogue Trees",
      "section": "Replacing Or Removing Trees",
      "level": "Advanced",
      "language": "json",
      "code": "{ \"replace\": true }"
    },
    ...
    },
    {
      ...
      "page": "quests",
      "pageTitle": "Quests",
      "section": "Builder Authoring Input",
      "level": "Starter",
      "language": "json",
      "code": "{\n  \"schema\": \"villagerretaliation:quest/v2\",\n  \"id\": \"my_pack:bread_delivery\",\n  \"metadata\": {\n    \"title\": \"Bread Delivery\",\n    \"description\": \"Bring 16 bread to the village stores.\",\n    \"questline\": \"village_supply\",\n    \"tags\": [\"group.village_supply\"]\n  },\n  \"provider\": {\n    \"type\": \"villagerretaliation:villager\",\n    \"filters\": {\n      \"professions\": [\"minecraft:farmer\"],\n      \"min_villager_level\": \"novice\"\n    }\n  },\n  \"availability\": {\n    \"repeatable\": true,\n    \"completion_cooldown_days\": 1,\n    \"locked_to_villager\": true,\n    \"cross_villager_compatible\": false,\n    \"abandonment\": \"allow_repickup\",\n    \"consume_on_completion\": true\n  },\n  \"entry_stage\": \"gather\",\n  \"stages\": [\n    {\n      \"id\": \"gather\",\n      \"objectives\": [\n        {\n          \"id\": \"bring_bread\",\n          \"type\": \"item_check\",\n          \"item\": \"minecraft:bread\",\n          \"count\": 16,\n          \"tracker\": {\n            \"text\": \"Bring 16 bread back to the quest giver.\",\n            \"complete_text\": \"The bread is packed and ready.\",\n            \"show_progress\": true,\n            \"progress\": 0.75\n          }\n        }\n      ],\n      \"dialogue\": {\n        \"offer\": {\n          \"label\": \"Bread Delivery\",\n          \"request\": \"question\",\n          \"order\": -20,\n          \"show_for_babies\": false,\n          \"lines\": [\n            \"The bins are low. Sixteen bread would quiet a lot of worried stomachs.\"\n          ],\n          \"responses\": [\n            {\n              \"id\": \"accept\",\n              \"label\": \"I can help stock the larder.\",\n              \"scene\": \"start_quest\"\n            },\n            {\n              \"id\": \"decline\",\n              \"label\": \"Another time.\",\n              \"scene\": \"decline\"\n            }\n          ]\n        },\n        \"reminder\": {\n          \"label\": \"About Bread Delivery\",\n          \"request\": \"question\",\n          \"order\": -20,\n          \"show_for_babies\": false,\n          \"lines\": [\n            \"Bread Delivery is still open. The tracker has the count.\"\n          ],\n          \"responses\": [\n            {\n              \"id\": \"leave\",\n              \"label\": \"I'll keep looking.\",\n              \"scene\": \"end\"\n            }\n          ]\n        },\n        \"turn_in\": {\n          \"label\": \"About Bread Delivery\",\n          \"request\": \"question\",\n          \"order\": -20,\n          \"show_for_babies\": false,\n          \"lines\": [\n            \"If that pack smells like fresh bread, you may have saved me an argument.\"\n          ],\n          \"responses\": [\n            {\n              \"id\": \"complete\",\n              \"label\": \"Show what I brought.\",\n              \"scene\": \"complete_quest\"\n            },\n            {\n              \"id\": \"leave\",\n              \"label\": \"Not yet.\",\n              \"scene\": \"end\"\n            }\n          ]\n        }\n      },\n      \"scenes\": [\n        {\n          \"id\": \"start_quest\",\n          \"actions\": [\n            {\n              \"type\": \"quest\",\n              \"action\": \"start\",\n              \"lines\": {\n                \"started\": [\n                  \"Good. Bring the bread back when the count is ready.\"\n                ],\n                \"unavailable\": [\n                  \"The larder is not asking you for bread right now.\"\n                ]\n              }\n            }\n          ]\n        },\n        {\n          \"id\": \"complete_quest\",\n          \"actions\": [\n            {\n              \"type\": \"quest\",\n              \"action\": \"turn_in\",\n              \"lines\": {\n                \"completed\": [\n                  \"Good. A full shelf makes brave talk sound less hollow.\"\n                ],\n                \"missing_objectives\": [\n                  \"Bread Delivery is still short. The tracker has the exact count.\"\n                ],\n                \"unavailable\": [\n                  \"This bread delivery is not ready to close yet.\"\n                ]\n              }\n            }\n          ]\n        },\n        {\n          \"id\": \"decline\",\n          \"text\": \"Then I will keep counting crumbs and pretending it is planning.\"\n        },\n        {\n          \"id\": \"end\",\n          \"text\": \"Keep the bread close until you are ready.\"\n        }\n      ]\n    }\n  ],\n  \"rewards\": {\n    \"experience\": 60,\n    \"reputation\": 5,\n    \"gossip_reputation\": 2\n  },\n  \"ui\": {\n    \"tracker_text\": \"Bring 16 bread.\",\n    \"icon\": \"minecraft:bread\",\n    \"color\": \"#DCEBA6\"\n  }\n}"
    },
    ...
    },
    {
      ...
      "page": "quests",
      "pageTitle": "Quests",
      "section": "Provider Protection And Hiring Policy",
      "level": "Advanced",
      "language": "json",
      "code": "{\n  \"provider\": {\n    \"type\": \"villagerretaliation:villager\",\n    \"death_protection\": \"while_active\",\n    \"blocks_hiring\": true,\n    \"filters\": {\n      \"professions\": [\"minecraft:cartographer\"]\n    }\n  }\n}"
    },
    ...
    },
    {
      ...
      "page": "quests",
      "pageTitle": "Quests",
      "section": "Forced Dialogue Action",
      "level": "Advanced",
      "language": "json",
      "code": "{\n  \"events\": [\n    {\n      \"id\": \"storm_reminder\",\n      \"event\": \"near_provider\",\n      \"radius\": 10,\n      \"cooldown_seconds\": 120,\n      \"conditions\": [\n        { \"type\": \"weather\", \"state\": \"thunder\" }\n      ],\n      \"actions\": [\n        {\n          \"type\": \"forced_dialogue\",\n          \"forced_dialogue\": \"my_pack.quest.storm_warning.reminder\"\n        }\n      ]\n    }\n  ]\n}"
    },
  ...
  "packs": [
    ...
    },
    {
      ...
      "files": [
        ...
        "data/example_template/quests/example_template/first_steps/locales/en_us.json",
        "data/example_template/quests/example_template/first_steps/quest.json",
