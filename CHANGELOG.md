...
- Kept two-villager horse drivers centered on the saddle while moving only the rear seat back for combat-model clearance, restored normal seating after dismounts and player takeovers, stabilized AI-ridden horse yaw and render transforms, and switched mounted travel to vanilla's raider-on-ravager navigation delegation.
