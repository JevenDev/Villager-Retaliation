...
- Consolidated player and operator commands under `/vr`, organized operator tools under `/vr admin`, standardized vanilla-style camel-case literals and explicit entity targets, and retained the older roots temporarily for compatibility.
