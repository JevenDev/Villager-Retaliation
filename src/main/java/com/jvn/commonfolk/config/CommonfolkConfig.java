...
public final class CommonfolkConfig {
    ...
    static {
        ...
        ENABLE_VILLAGER_DROPS = BUILDER
                ...
                .translation("commonfolk.configuration.general.enableVillagerDrops")
        ...
        ENABLE_WANDERING_TRADER_DROPS = BUILDER
                ...
                .translation("commonfolk.configuration.general.enableWanderingTraderDrops")
        ...
        ENABLE_VILLAGER_RETALIATION = BUILDER
                ...
                .translation("commonfolk.configuration.general.enableVillagerRetaliation")
        ...
        BABY_VILLAGERS_DROP_LOOT = BUILDER
                ...
                .translation("commonfolk.configuration.balance.babyVillagersDropLoot")
        ...
        REQUIRE_PLAYER_KILL_FOR_PROFESSION_LOOT = BUILDER
                ...
                .translation("commonfolk.configuration.balance.requirePlayerKillForProfessionLoot")
                .define("requirePlayerKillForProfessionLoot", true);
        BUILDER.comment("Chance for adult villagers to drop 1-5 emeralds.");
        VILLAGER_EMERALD_DROP_CHANCE = chance("villagerEmeraldDropChance", "commonfolk.configuration.balance.villagerEmeraldDropChance", 0.35);
        BUILDER.comment("Chance for adult villagers to drop 1-3 bread.");
        VILLAGER_BREAD_DROP_CHANCE = chance("villagerBreadDropChance", "commonfolk.configuration.balance.villagerBreadDropChance", 0.60);
        BUILDER.comment("Chance for adult villagers to roll their profession-specific loot pool.");
        PROFESSION_DROP_CHANCE = chance("professionDropChance", "commonfolk.configuration.balance.professionDropChance", 0.50);
        BUILDER.comment("Chance used by rare profession drops.");
        RARE_DROP_CHANCE = chance("rareDropChance", "commonfolk.configuration.balance.rareDropChance", 0.05);
        BUILDER.comment("Chance used by very rare profession drops.");
        VERY_RARE_DROP_CHANCE = chance("veryRareDropChance", "commonfolk.configuration.balance.veryRareDropChance", 0.01);
        BUILDER.pop();
        ...
        ATTACK_AGGROS_ONLY_HIT_VILLAGER = BUILDER
                ...
                .translation("commonfolk.configuration.retaliation.attackAggrosOnlyHitVillager")
        ...
        KILLING_VILLAGER_AGGROS_NEARBY_VILLAGERS = BUILDER
                ...
                .translation("commonfolk.configuration.retaliation.killingVillagerAggrosNearbyVillagers")
        ...
        VILLAGER_KILL_AGGRO_RADIUS = BUILDER
                ...
                .translation("commonfolk.configuration.retaliation.villagerKillAggroRadius")
        ...
        AGGRO_DURATION_TICKS = BUILDER
                ...
                .translation("commonfolk.configuration.retaliation.aggroDurationTicks")
        ...
        NEARBY_VILLAGERS_IGNORE_CREATIVE_PLAYERS = BUILDER
                ...
                .translation("commonfolk.configuration.retaliation.nearbyVillagersIgnoreCreativePlayers")
        ...
        WEAPONSMITHS_FIGHT_BACK = BUILDER.comment("Allows weaponsmiths to retaliate with stronger melee behavior.")
                .translation("commonfolk.configuration.combat.weaponsmithsFightBack")
        ...
        TOOLSMITHS_FIGHT_BACK = BUILDER.comment("Allows toolsmiths to retaliate with melee behavior.")
                .translation("commonfolk.configuration.combat.toolsmithsFightBack")
        ...
        ARMORERS_FIGHT_BACK = BUILDER.comment("Allows armorers to retaliate and gain short defensive resistance.")
                .translation("commonfolk.configuration.combat.armorersFightBack")
        ...
        FLETCHERS_FIGHT_BACK = BUILDER.comment("Allows fletchers to retaliate, including simple ranged shots.")
                .translation("commonfolk.configuration.combat.fletchersFightBack")
                .define("fletchersFightBack", true);
        BUTCHERS_FIGHT_BACK = BUILDER.comment("Allows butchers to retaliate with melee behavior.")
                .translation("commonfolk.configuration.combat.butchersFightBack")
        ...
        COMBAT_WEAPON_DROP_CHANCE = BUILDER
                .translation("commonfolk.configuration.combat.combatWeaponDropChance")
        ...
        COMBAT_WEAPON_ENCHANT_CHANCE = BUILDER
                .translation("commonfolk.configuration.combat.combatWeaponEnchantChance")
        ...
        FARMERS_USE_BREAD = BUILDER.comment("Allows farmers to retaliate defensively and heal themselves when hurt.")
                .translation("commonfolk.configuration.combat.farmersUseBread")
        ...
        WANDERER_DROP_EMERALDS = BUILDER.comment("Allows wandering traders to drop 1-5 emeralds.")
                .translation("commonfolk.configuration.wanderer.dropEmeralds")
        ...
        WANDERER_DROP_INVISIBILITY_POTION = BUILDER.comment("Allows wandering traders to drop one invisibility potion.")
                .translation("commonfolk.configuration.wanderer.dropInvisibilityPotion")
        ...
        WANDERER_DROP_RANDOM_CURRENT_TRADE = BUILDER.comment("Allows wandering traders to drop a safe copy of one current trade result.")
                .translation("commonfolk.configuration.wanderer.dropRandomCurrentTrade")
                .define("dropRandomCurrentTrade", true);
        BUILDER.comment("Chance for the wandering trader random trade result drop.");
        WANDERER_RANDOM_TRADE_DROP_CHANCE = chance("randomTradeDropChance", "commonfolk.configuration.wanderer.randomTradeDropChance", 0.50);
        BUILDER.pop();
